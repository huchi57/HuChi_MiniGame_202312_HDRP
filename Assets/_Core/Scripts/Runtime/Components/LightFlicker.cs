...
namespace UrbanFox
{
    ...
    public class LightFlicker : MonoBehaviour
    {
        ...
        [SerializeField]
        private string _pattern = "m";

        [SerializeField]
        private LightFlickerUtility.Preset _preset = LightFlickerUtility.Preset.Normal;
        ...
        [SerializeField]
        private float _patternDuration = 1;
        ...
        public float NormalBrightness
        {
            get => _normalBrightness;
            set => _normalBrightness = value;
        }

        public float PatternDuration
        {
            get => _patternDuration;
            set => _patternDuration = value;
        }
